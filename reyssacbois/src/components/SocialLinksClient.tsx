...
function FacebookIcon() {
  // Simple Icons (facebook) — https://cdn.jsdelivr.net/npm/simple-icons@v16/icons/facebook.svg
  return (
...
function InstagramIcon() {
  // Simple Icons (instagram) — https://cdn.jsdelivr.net/npm/simple-icons@v16/icons/instagram.svg
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5">
