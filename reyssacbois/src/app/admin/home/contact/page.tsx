...
import { ensureContactInfoSettings, getSettingsVersion, SITE_KEYS } from "@/admin/queries/siteSettings";
import ContactInfoForm from "./ContactInfoForm";

export default async function AdminHomeContactPage() {
  const contactInfo = await ensureContactInfoSettings();
  const version = await getSettingsVersion([SITE_KEYS.contactInfo]);
  ...
  return (
    <div>
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-ink-600">
              Bloc “Informations” de la section Contact.
            </p>
      ...
      <ContactInfoForm initial={contactInfo} version={version} />
    </div>
  );
}
